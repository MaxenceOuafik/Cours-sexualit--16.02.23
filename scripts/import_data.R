...
patients_data <- read_delim(here::here("./2023/data/patients_data.csv"),
...
aim_data <- read_delim(here::here("./2023/data/AIM_data.csv"),
                       locale = locale(decimal_mark = ","))       

refnis_postal <- read_delim(here::here("./2023/data/refnis_postal.csv"),
                            locale = locale(encoding = "UTF-8"))
...
cities_geocoded <- read_delim("2023/data/belgian-cities-geocoded.csv") |>
